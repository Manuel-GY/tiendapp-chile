document.addEventListener("DOMContentLoaded", function () {
  ...
  btn.addEventListener("click", function () {
    ...
    if (!email) {
      alert("Por favor ingresa tu correo electronico para recibir la guia de instalacion.");
    ...
    btn.disabled = true;
    btn.innerHTML = '<i class="fa-solid fa-spinner fa-spin"></i> Redirigiendo a Flow...';
